...
BEGIN {
    ...
    require 'D:/Visual_Studio_Code_Workspace/ThucHanhMatMaHoc/Lab4/openssl-3.3.2/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'D:/Visual_Studio_Code_Workspace/ThucHanhMatMaHoc/Lab4/openssl-3.3.2/test/fips-and-base.cnf';
    shift;
